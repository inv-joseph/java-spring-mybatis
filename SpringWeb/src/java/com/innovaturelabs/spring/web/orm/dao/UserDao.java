 ...
 */
package java.com.innovaturelabs.spring.web.orm.dao;

import com.innovaturelabs.spring.util.Pager;
import java.com.innovaturelabs.spring.web.form.SignupForm;
import java.com.innovaturelabs.spring.web.form.UserForm;
import java.com.innovaturelabs.spring.web.orm.entity.User;
import java.com.innovaturelabs.spring.web.orm.entity.UserSns;
import java.com.innovaturelabs.spring.web.orm.entity.UserSnsId;
import java.com.innovaturelabs.spring.web.orm.view.UserView;
...
public class UserDao {
    ...
    public UserView getUserView(int userId) {
        String sql = "select new com.innovaturelabs.spring.web.orm.view.UserView("
