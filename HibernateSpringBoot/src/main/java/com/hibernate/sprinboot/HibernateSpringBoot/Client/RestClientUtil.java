package com.hibernate.sprinboot.HibernateSpringBoot.Client;
...
public class RestClientUtil {
	...
	public void updateArticleDemo() {
        ...
        objArticle.setTitle("Update:Java Concurrency-updated");
        objArticle.setCategory("Java-updated");
	...
	public void addArticleDemo() {
        ...
        String url = "http://localhost:8080/user/article";
        Article objArticle = new Article();
        objArticle.setTitle("Update:PHP Tutor");
    	objArticle.setCategory("PHP habits");
        HttpEntity<Article> requestEntity = new HttpEntity<Article>(objArticle, headers);
